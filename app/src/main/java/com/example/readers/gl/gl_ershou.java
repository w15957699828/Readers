...
import com.example.readers.comment.es.Es2Adapter;
import com.example.readers.comment.es.Es2Data;
...
public class gl_ershou extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonlysr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataSupport.deleteAll(Es2Data.class,"commentes = ?",nr);   //
                lysrpl.setText("");
