...
import com.example.readers.comment.szbf.SzbfAdapter;
import com.example.readers.comment.szbf.SzbfData;
...
public class gl_ct_szbf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonlysr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataSupport.deleteAll(SzbfData.class,"commentsz = ?",nr);   //
                lysrpl.setText("");
